            ...
            <div className="min-h-screen bg-[#081C3A] text-white">
                ...
                <div className="sticky top-0 z-10 bg-gradient-to-b from-[#094298] to-[#0f6ffe00] px-8 py-6 backdrop-blur-sm">
                    <div className="max-w-7xl mx-auto flex flex-row justify-between items-center">
                        <Link href="/" className="cursor-pointer gap-2 flex flex-row items-center bg-white/10 backdrop-blur-sm rounded-full p-3 border border-white/10 hover:bg-[#0E6DFD]/30">
